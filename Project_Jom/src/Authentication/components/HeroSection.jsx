      ...
      <div className="chat-widget__messages">
        <div className="chat-msg">
          ...
          <div className="chat-msg__bubble">
            Hello! I'm your Tampines community assistant. What government
            service can I help you with today?
          </div>
        </div>
        ...
        <div className="chat-msg">
          <div className="chat-msg__avatar">🤖</div>
          <div className="chat-msg__bubble">
            You can check your CPF balance by logging in to my.cpf.gov.sg with
            your Singpass. Want me to guide you step by step?
          </div>
        </div>
      </div>
      ...
      <div className="container hero__inner">
        <div className="hero__content">
          ...
          <h1 className="hero__title">
            Welcome to <span className="hero__title-accent">MyTampines</span>{" "}
            Assistant
          </h1>

          <p className="hero__desc">
            Your personal guide to Singapore government services — CPF, HDB,
            healthcare, benefits, and more. All in one place, available 24/7.
          </p>
          ...
          <div className="hero__cta">
            <Link to="/select-profile" className="btn btn-primary">
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
